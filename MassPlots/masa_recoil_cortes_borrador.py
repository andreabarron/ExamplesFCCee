...
dfMuonsHZ = dfMuonsHZ.Filter("Muon_ptHZ[0] > 20 && Muon_ptHZ[0] < 70 && Muon_ptHZ[1] > 20 && Muon_ptHZ[1] < 70")
...
hZmassHZ = dfMuonsHZ.Histo1D(("hZmassHZ", "Zmass ; m_{Z} (GeV) ; N_{Events}", 100,60,120),
"Z_massHZ")
...
dfMuonsWW = dfMuonsWW.Filter("Muon_ptWW[0] > 20 && Muon_ptWW[0] < 70 && Muon_ptWW[1] > 20 && Muon_ptWW[1] < 70")
...
dfMuonsZZ = dfMuonsZZ.Filter("Muon_ptZZ[0] > 20 && Muon_ptZZ[0] < 70 && Muon_ptZZ[1] > 20 && Muon_ptZZ[1] < 70")
...
out = ROOT.TFile("histos_cortes.root","RECREATE")   #guardamos los histogramas en un archivo ROOT
...
dfMuonsHZ = dfMuonsHZ.Filter("recoilmassHZ > 120 && recoilmassHZ < 140")
...
hrecoilmassHZ = dfMuonsHZ.Histo1D(("hrecoilmassHZ", "Masa del recoil proceso HZ; m_{recoil} (GeV); N_{Events}", 100, 120, 140), "recoilmassHZ")


#Sacamos el ángulo theta y el coseno del ángulo theta

dfMuonsHZ = dfMuonsHZ.Define("HZ_ang","recoilHZ.Theta()")
dfMuonsHZ = dfMuonsHZ.Define("cosenoangHZ","cos(HZ_ang)")
dfMuonsHZ = dfMuonsHZ.Define("abscosenoangHZ","abs(cosenoangHZ)")
dfMuonsHZ = dfMuonsHZ.Filter("abscosenoangHZ < 0.98")
hcosangHZ = dfMuonsHZ.Histo1D(("hcosangHZ", "Coseno del ángulo theta del recoil; cos(#theta); N_{Events}", 100, 0, 1), "abscosenoangHZ") 
...
dfMuonsWW = dfMuonsWW.Filter("recoilmassWW > 120 && recoilmassWW < 140")

#print (recoilmassHZ)


hrecoilmassWW = dfMuonsWW.Histo1D(("hrecoilmassWW", "Masa del recoil proceso WW; m_{recoil} (GeV); N_{Events}", 100, 120, 140), "recoilmassWW")


#Sacamos el ángulo theta y el coseno del ángulo theta

dfMuonsWW = dfMuonsWW.Define("WW_ang","recoilWW.Theta()")
dfMuonsWW = dfMuonsWW.Define("cosenoangWW","cos(WW_ang)")
dfMuonsWW = dfMuonsWW.Define("abscosenoangWW","abs(cosenoangWW)")
dfMuonsWW = dfMuonsWW.Filter("abscosenoangWW < 0.98")
hcosangWW = dfMuonsWW.Histo1D(("hcosangWW", "Coseno del ángulo theta del recoil; cos(#theta); N_{Events}", 100, 0, 1), "abscosenoangWW")
...
dfMuonsZZ = dfMuonsZZ.Filter("recoilmassZZ > 120 && recoilmassZZ < 140")

#print (recoilmassHZ)


hrecoilmassZZ = dfMuonsZZ.Histo1D(("hrecoilmassZZ", "Masa del recoil proceso ZZ; m_{recoil} (GeV); N_{Events}", 100, 120, 140), "recoilmassZZ")


#Sacamos el ángulo theta y el coseno del ángulo theta

dfMuonsZZ = dfMuonsZZ.Define("ZZ_ang","recoilZZ.Theta()")
dfMuonsZZ = dfMuonsZZ.Define("cosenoangZZ","cos(ZZ_ang)")
dfMuonsZZ = dfMuonsZZ.Define("abscosenoangZZ","abs(cosenoangZZ)")
dfMuonsZZ = dfMuonsZZ.Filter("abscosenoangZZ < 0.98")
hcosangZZ = dfMuonsZZ.Histo1D(("hcosangZZ", "Coseno del ángulo theta del recoil; cos(#theta); N_{Events}", 100, 0, 1),"abscosenoangZZ")
...
out = ROOT.TFile("histos_higgs_cortes.root","RECREATE")   #guardamos los histogramas en un archivo ROOT
